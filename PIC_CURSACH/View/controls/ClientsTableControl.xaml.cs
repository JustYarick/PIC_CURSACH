...
public partial class ClientsTableControl : UserControl
{
    ...
    public ClientsTableViewModel? ViewModel { get; private set; }
    private bool _isLoaded = false;

    public ClientsTableControl()
    {
        InitializeComponent();
    }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            ViewModel = serviceProvider.GetRequiredService<ClientsTableViewModel>();
