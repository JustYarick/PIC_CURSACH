...
public partial class DepositTypesTableControl : UserControl
{
    public static readonly DependencyProperty CanAddProperty =
        DependencyProperty.Register(nameof(CanAdd), typeof(bool),
            typeof(DepositTypesTableControl), new PropertyMetadata(true));
    ...
    public DepositTypesTableViewModel? ViewModel { get; private set; }
    private bool _isLoaded = false;

    public DepositTypesTableControl()
    {
        InitializeComponent();
    }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            ViewModel = serviceProvider.GetRequiredService<DepositTypesTableViewModel>();
