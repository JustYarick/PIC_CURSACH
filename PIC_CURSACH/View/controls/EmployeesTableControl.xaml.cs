...
public partial class EmployeesTableControl : UserControl
{
    public static readonly DependencyProperty CanAddProperty =
        DependencyProperty.Register(nameof(CanAdd), typeof(bool),
            typeof(EmployeesTableControl), new PropertyMetadata(true));
    ...
    public EmployeesTableViewModel? ViewModel { get; private set; }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            ViewModel = serviceProvider.GetRequiredService<EmployeesTableViewModel>();
