...
public partial class DocumentsTableControl : UserControl
{
    ...
    public DocumentsTableViewModel? ViewModel { get; private set; }
    private bool _isLoaded = false;

    public DocumentsTableControl()
    {
        InitializeComponent();
    }
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            ViewModel = serviceProvider.GetRequiredService<DocumentsTableViewModel>();
